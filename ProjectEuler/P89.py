...
each number (see FAQ: Roman Numerals). However, there is always a best
...
def roman_to_int(input):
   ...
   return sum
   # Remove the original value test, since the whole point of this
   #  is to parse invalid roman numerals
